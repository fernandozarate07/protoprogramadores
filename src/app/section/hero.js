      ...
      <main className={styles.main}>
        <div className={styles.text_container}>
          ...
          <p className={styles.description}>
            Nuestro objetivo es
            <span className={styles.strong}> IMPULSAR el crecimiento de empresas y emprendedores </span>con una
            presencia online que destaque y los ayude a alcanzar sus metas.
          </p>
          <Button_one />
        </div>
